...
<html>
	...
	<body>
        ...
        <g:hasErrors bean="${politicalStatusInstance}">
            <ul class="alert alert-error" >
                <g:eachError bean="${politicalStatusInstance}" var="error">
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    ...
                    <g:hiddenField name="version" value="${politicalStatusInstance?.version}" />
                    <fieldset>
