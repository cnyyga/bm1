                ...
                <table class="table table-bordered table-striped table-condensed">
                    ...
                    <g:each in="${financeInstanceList}" status="i" var="financeInstance">
                        <tr>
                            ...
                            <td class="center">${fieldValue(bean: financeInstance, field: "username")}</td>
                            

                            <td class="center">${fieldValue(bean: financeInstance, field: "name")}</td>

                            <td class="center">
                                <span class="label  ${financeInstance.enabled?'label-success':''}">
                                    <g:formatBoolean boolean="${financeInstance.enabled}" />
                                </span>
                            </td>
                            
                            <td class="center">
                                    <g:link class="btn btn-success" action="show" id="${financeInstance.id}">
                                    ...
                                    <g:link class="btn btn-danger" action="delete" id="${financeInstance.id}">
