...
<html>
	...
	<body>
        ...
        <g:hasErrors bean="${financeInstance}">
            <ul class="alert alert-error" >
                <g:eachError bean="${financeInstance}" var="error">
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    <g:form class="form-horizontal" action="update" name="editForm">
                    <g:hiddenField name="id" value="${financeInstance?.id}" />
                    <g:hiddenField name="version" value="${financeInstance?.version}" />
                    <fieldset>
