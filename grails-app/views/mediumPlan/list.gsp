            ...
            <div class="box-content">
                <table class="table table-bordered table-striped table-condensed">
                    ...
                    <tr>
                        ...
                        <th><g:message code="mediumPlan.code.label" default="Code" /></th>

                        
                        <th><g:message code="mediumPlan.name.label" default="Name" /></th>
                    ...
                    <tbody>
                    <g:each in="${mediumPlanInstanceList}" status="i" var="mediumPlanInstance">
                        <tr>
                            
                            <td class="center">${fieldValue(bean: mediumPlanInstance, field: "code")}</td>
                            
                            <td class="center">${fieldValue(bean: mediumPlanInstance, field: "name")}</td>
                            
                            <td class="center">${mediumPlanInstance.status?.label}</td>
                            
                            <td class="center">
                                    <g:link class="btn btn-success" action="show" id="${mediumPlanInstance.id}">
                                 ...
                                 %{--   <g:link class="btn btn-danger" action="delete" id="${mediumPlanInstance.id}">
                ...
                <div class="pagination pagination-centered">
                    <g:paginate total="${mediumPlanInstanceTotal}" />
                </div>
            </div>
        </div><!--/span-->
