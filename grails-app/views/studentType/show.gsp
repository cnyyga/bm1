    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                <fieldset>
                    <g:if test="${studentTypeInstance?.name}">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${studentTypeInstance}" field="name"/></span>

                            </div>
                        </div>
                    </g:if>

                    <g:if test="${studentTypeInstance?.code}">
                    <div class="control-group">
                        <label class="control-label">
                        ...
                        <div class="controls">
                            ...
                            <span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${studentTypeInstance}" field="code"/></span>
                    ...
                    <div class="form-actions">
                        <g:form>
                                <g:hiddenField name="id" value="${studentTypeInstance?.id}" />
