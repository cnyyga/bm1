            ...
            <div class="box-content">
                ...
                <fieldset>
                    ...
                    <g:if test="${nationInstance?.name}">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${nationInstance}" field="name"/></span>

                            </div>
                        </div>
                    </g:if>

                    <g:if test="${nationInstance?.code}">
                    <div class="control-group">
                        <label class="control-label">
                        ...
                        <div class="controls">
                            ...
                            <span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${nationInstance}" field="code"/></span>
                    ...
                    <div class="form-actions">
                        <g:form>
                                <g:hiddenField name="id" value="${nationInstance?.id}" />
