...
grails.plugins.springsecurity.interceptUrlMap = [
        ...
        '/student/edit/**': ['ROLE_ADMIN'],
        '/preppy/**': ['ROLE_ADMIN','ROLE_FINANCE','ROLE_TEACHER'],
        '/medium/**': ['ROLE_ADMIN','ROLE_TEACHER'],
        '/student/createNew/**': ['ROLE_ADMIN','ROLE_TEACHER'],
        '/student/saveNew/**': ['ROLE_ADMIN','ROLE_TEACHER'],
        '/student/delete/**': ['ROLE_ADMIN'],
        '/student/create/**': ['ROLE_ADMIN'],
        '/student/save/**': ['ROLE_ADMIN'],
        '/student/update/**': ['ROLE_ADMIN'],
        '/student/**': ['ROLE_ADMIN','ROLE_TEACHER'],
        ...
        '/query/**': ['IS_AUTHENTICATED_ANONYMOUSLY'],
        '/workPlan/**': ['ROLE_ADMIN','ROLE_FINANCE','ROLE_TEACHER'],
        '/mobile/createStu/**': ['ROLE_ADMIN','ROLE_TEACHER'],
        '/mobile/createStu/**': ['ROLE_ADMIN','ROLE_TEACHER'],
        '/mobile/addStu/**': ['ROLE_ADMIN','ROLE_TEACHER'],
        '/mobile/addPreppy/**': ['ROLE_ADMIN','ROLE_FINANCE','ROLE_TEACHER'],
        '/mobile/addMedium/**': ['ROLE_ADMIN','ROLE_TEACHER'],
